...
var checkIsInRenderer = _p.checkIsInRenderer = function () {
...
_p._$indexOf = function (_list, _item) {
  var _filter = _p._$isFunction(_item) ? _item : function (_value) { return _value === _item }
  var _index = _p._$forIn(_list, _filter)
...
_p._$binSearch = (function () {
  ...
  var _doSearch = function (_list, _low, _high) {
    ...
    var _result = _docheck(_list[_middle], _middle, _list)
...
_p._$fixed = function (_float, _fraction) {
  return parseFloat(_float.toFixed(_fraction))
}
/**
 * 相对路径转绝对路径
 *
...
_p._$number2string = function (_number, _limit) {
  ...
  var _len2 = Math.max(1, parseInt(_limit) || 0)
  var _delta = _len2 - _len1
  if (_delta > 0) {
