...
<transition name="fade">
  <div class="m-checkuser-con" ref="checkUser" v-if="showCheckUser" :style="{left, top, height}" v-clickoutside="closeModal">
    ...
    <div class="user-tel"><span>职位</span><span class="line" :title="userInfos.position">{{userInfos.position}}</span></div>
    <div class="user-tel"><span>工号</span><span class="line" :style="{color: userInfos.jobNum ? '#333' : '#999'}" :title="userInfos.jobNum">{{userInfos.jobNum ? userInfos.jobNum : '未设置'}}</span></div>
