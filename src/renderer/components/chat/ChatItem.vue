  ...
  <li class="u-msg"
    ...
    >
      ...
      >
        ...
        <!-- <div v-else-if="msg.type==='custom-type7'" class="msg-text html-calss" v-html="msg.showText" @mouseup.stop="!isCheckMore && showListOptions($event, msg.type)">
        </div> -->
        <!-- 群邀请消息 -->
